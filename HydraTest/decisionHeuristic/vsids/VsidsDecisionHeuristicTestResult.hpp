...
namespace HydraTest::DecisionHeuristic::Vsids {
    inline std::string vsidsDecisionHeuristicResult = "Decision heuristic\n"
                                                      "Type: variable state independent decaying sum (VSIDS)\n"
    ...
    inline std::string vsidsDecisionHeuristicSelectedVariablesResult = "Decision heuristic\n"
                                                                       "Type: variable state independent decaying sum (VSIDS)\n"
                                                                       "Ignore pure literal type: pure literals are not ignored\n"
                                                                       "\n"
                                                                       "\n"
