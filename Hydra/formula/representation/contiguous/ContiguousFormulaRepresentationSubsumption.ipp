...
namespace Hydra::Formula::Representation::Contiguous {
    ...
    bool ContiguousFormulaRepresentation<VarT, LiteralT, ClauseIdT>::clauseSubsumesClause(ClauseIdT clauseId1, ClauseIdT clauseId2) const {
    ...
    template <typename VarT, typename LiteralT, typename ClauseIdT>
    bool ContiguousFormulaRepresentation<VarT, LiteralT, ClauseIdT>::clauseVariableSubsumesClause(ClauseIdT clauseId1, ClauseIdT clauseId2) const {
        assert(clauseId1 < this->numberOfOriginalClauses_);
        assert(clauseId2 < this->numberOfOriginalClauses_);
        assert(this->isClauseUnresolved(clauseId1));   // clause is unresolved
        assert(this->isClauseUnresolved(clauseId2));   // clause is unresolved
    ...
    template <typename VarT, typename LiteralT, typename ClauseIdT>
    void ContiguousFormulaRepresentation<VarT, LiteralT, ClauseIdT>::backwardSubsumptionDetectionIntersection(VectorSetType& subsumedClauseVectorSet,
    ...
    template <typename VarT, typename LiteralT, typename ClauseIdT>
    void ContiguousFormulaRepresentation<VarT, LiteralT, ClauseIdT>::backwardSubsumptionDetection(VectorSetType& subsumedClauseVectorSet,
                                                                                                  bool considerOnlyVariables) const {
        assert(subsumedClauseVectorSet.empty());
    ...
    template <typename VarT, typename LiteralT, typename ClauseIdT>
    void ContiguousFormulaRepresentation<VarT, LiteralT, ClauseIdT>::forwardSubsumptionDetection(VectorSetType& subsumedClauseVectorSet,
                                                                                                 bool considerOnlyVariables) const {
        assert(subsumedClauseVectorSet.empty());
    ...
    template <typename VarT, typename LiteralT, typename ClauseIdT>
    void ContiguousFormulaRepresentation<VarT, LiteralT, ClauseIdT>::oneLiteralWatchingAlgorithmSubsumption(VectorSetType& subsumedClauseVectorSet) const {
        assert(subsumedClauseVectorSet.empty());
    ...
    template <typename VarT, typename LiteralT, typename ClauseIdT>
    bool ContiguousFormulaRepresentation<VarT, LiteralT, ClauseIdT>::isClauseSubsumedOneLiteralWatchingAlgorithmSubsumption(ClauseIdT clauseId,
    ...
    template <typename VarT, typename LiteralT, typename ClauseIdT>
    bool ContiguousFormulaRepresentation<VarT, LiteralT, ClauseIdT>::updateWatcherOneLiteralWatchingAlgorithmSubsumption(ClauseIdT clauseId) const {
    ...
    template <typename VarT, typename LiteralT, typename ClauseIdT>
    void ContiguousFormulaRepresentation<VarT, LiteralT, ClauseIdT>::oneLiteralWatchingAlgorithmVariableSubsumption(VectorSetType& variableSubsumedClauseVectorSet) const {
    ...
    template <typename VarT, typename LiteralT, typename ClauseIdT>
    bool ContiguousFormulaRepresentation<VarT, LiteralT, ClauseIdT>::isClauseVariableSubsumedOneLiteralWatchingAlgorithmVariableSubsumption(ClauseIdT clauseId,
    ...
    template <typename VarT, typename LiteralT, typename ClauseIdT>
    bool ContiguousFormulaRepresentation<VarT, LiteralT, ClauseIdT>::updateWatcherOneLiteralWatchingAlgorithmVariableSubsumption(ClauseIdT clauseId) const {
        ClauseSizeType index = l_indexSubsumptionWatcherVector_oneLiteralWatchingAlgorithmSubsumption_[clauseId];
