...
namespace Hydra::Formula::Representation::Contiguous {
    ...
    template <typename VarT, typename LiteralT, typename ClauseIdT>
    void ContiguousFormulaRepresentation<VarT, LiteralT, ClauseIdT>::sortClauseIdReusableVectorWithGroupingBySizes(ClauseIdReusableVectorType& clauseIdReusableVector,
    ...
    template <typename VarT, typename LiteralT, typename ClauseIdT>
    void ContiguousFormulaRepresentation<VarT, LiteralT, ClauseIdT>::removeDuplicateClausesFromClauseIdReusableVector(ClauseIdReusableVectorType& clauseIdReusableVector,
    ...
    template <typename VarT, typename LiteralT, typename ClauseIdT>
    void ContiguousFormulaRepresentation<VarT, LiteralT, ClauseIdT>::sortClauses(ClauseIdReusableVectorType& clauseIdReusableVector,
            ...
            switch (omitClauseType) {
                ...
                default:
                    throw Exception::NotImplementedException(Cache::CachingScheme::omitClauseTypeEnumToString(omitClauseType),
                                                             "Hydra::Formula::Representation::Contiguous::ContiguousFormulaRepresentation::sortClauses");
            }
    ...
    template <typename VarT, typename LiteralT, typename ClauseIdT>
    typename ContiguousFormulaRepresentation<VarT, LiteralT, ClauseIdT>::ClauseSizeType
    ContiguousFormulaRepresentation<VarT, LiteralT, ClauseIdT>::getIndexOfUnassignedLiteralInClause(ClauseIdT clauseId,
    ...
    template <typename VarT, typename LiteralT, typename ClauseIdT>
    bool ContiguousFormulaRepresentation<VarT, LiteralT, ClauseIdT>::updateClauseWatcher(ClauseIdT clauseId,
    ...
    template <typename VarT, typename LiteralT, typename ClauseIdT>
    void ContiguousFormulaRepresentation<VarT, LiteralT, ClauseIdT>::processAddLiteralToPartialAssignment(const LiteralType& lit,
    ...
    template <typename VarT, typename LiteralT, typename ClauseIdT>
    void ContiguousFormulaRepresentation<VarT, LiteralT, ClauseIdT>::processRemoveLiteralFromPartialAssignment(const LiteralType& lit,
    ...
    template <typename VarT, typename LiteralT, typename ClauseIdT>
    void ContiguousFormulaRepresentation<VarT, LiteralT, ClauseIdT>::processAddClausesContainingOnlyPureLiteralsOfIgnoredType(const ClauseIdSetType& pureClauseSet) {
    ...
    template <typename VarT, typename LiteralT, typename ClauseIdT>
    void ContiguousFormulaRepresentation<VarT, LiteralT, ClauseIdT>::processRemoveClausesContainingOnlyPureLiteralsOfIgnoredType(const ClauseIdSetType& pureClauseSet) {
        // Current component clauses
        currentComponentClausesStack_.emplace_back(static_cast<ClauseIdT>(currentComponentClausesFixedVector_.size()));
    ...
    template <typename VarT, typename LiteralT, typename ClauseIdT>
    typename ContiguousFormulaRepresentation<VarT, LiteralT, ClauseIdT>::ConnectedComponentType
    ContiguousFormulaRepresentation<VarT, LiteralT, ClauseIdT>::processComputeConnectedComponents(const VariableSetType& currentComponentVariableSet) const {
    ...
    template <typename VarT, typename LiteralT, typename ClauseIdT>
    typename ContiguousFormulaRepresentation<VarT, LiteralT, ClauseIdT>::ConnectedComponentType
    ContiguousFormulaRepresentation<VarT, LiteralT, ClauseIdT>::processComputeConnectedComponents(const VariableSetType& currentComponentVariableSet,
    ...
    template <typename VarT, typename LiteralT, typename ClauseIdT>
    bool ContiguousFormulaRepresentation<VarT, LiteralT, ClauseIdT>::processIsCurrentComponentFormulaKromC([[maybe_unused]] const VariableSetType& currentComponentVariableSet) const {
    ...
    template <typename VarT, typename LiteralT, typename ClauseIdT>
    bool ContiguousFormulaRepresentation<VarT, LiteralT, ClauseIdT>::processIsCurrentComponentFormulaHornC([[maybe_unused]] const VariableSetType& currentComponentVariableSet) const {
    ...
    template <typename VarT, typename LiteralT, typename ClauseIdT>
    bool ContiguousFormulaRepresentation<VarT, LiteralT, ClauseIdT>::processIsCurrentComponentFormulaAntiHornC([[maybe_unused]] const VariableSetType& currentComponentVariableSet) const {
    ...
    template <typename VarT, typename LiteralT, typename ClauseIdT>
    void ContiguousFormulaRepresentation<VarT, LiteralT, ClauseIdT>::processSaveCurrentComponentFormulaToVector(const VariableSetType& currentComponentVariableSet,
    ...
    template <typename VarT, typename LiteralT, typename ClauseIdT>
    ContiguousFormulaRepresentation<VarT, LiteralT, ClauseIdT>::ClauseSizeType
    ContiguousFormulaRepresentation<VarT, LiteralT, ClauseIdT>::getMaxOriginalClauseSize() const noexcept {
        return maxOriginalClauseSize_;
    }

    template <typename VarT, typename LiteralT, typename ClauseIdT>
    const typename ContiguousFormulaRepresentation<VarT, LiteralT, ClauseIdT>::LiteralType&
    ContiguousFormulaRepresentation<VarT, LiteralT, ClauseIdT>::getLiteralAtPositionInClause(ClauseIdT clauseId, ClauseSizeType position) const {
        assert(clauseId < this->numberOfOriginalClauses_);
    ...
    template <typename VarT, typename LiteralT, typename ClauseIdT>
    ClauseStatusEnum ContiguousFormulaRepresentation<VarT, LiteralT, ClauseIdT>::getCurrentClauseStatus(ClauseIdT clauseId) const {
        assert(clauseId < this->numberOfOriginalClauses_);
    ...
    template <typename VarT, typename LiteralT, typename ClauseIdT>
    typename ContiguousFormulaRepresentation<VarT, LiteralT, ClauseIdT>::ClauseSizeType
    ContiguousFormulaRepresentation<VarT, LiteralT, ClauseIdT>::getCurrentClauseSize(ClauseIdT clauseId) const {
        assert(clauseId < this->numberOfOriginalClauses_);
        assert(!this->isClauseSatisfied(clauseId));   // clause is not satisfied
    ...
    template <typename VarT, typename LiteralT, typename ClauseIdT>
    bool ContiguousFormulaRepresentation<VarT, LiteralT, ClauseIdT>::isClauseUntouched(ClauseIdT clauseId) const {
        assert(clauseId < this->numberOfOriginalClauses_);
    ...
    template <typename VarT, typename LiteralT, typename ClauseIdT>
    bool ContiguousFormulaRepresentation<VarT, LiteralT, ClauseIdT>::isLiteralInUnitClause(const LiteralType& lit) const {
    ...
    template <typename VarT, typename LiteralT, typename ClauseIdT>
    bool ContiguousFormulaRepresentation<VarT, LiteralT, ClauseIdT>::isVariableFree(VarT var) const {
    ...
    template <typename VarT, typename LiteralT, typename ClauseIdT>
    bool ContiguousFormulaRepresentation<VarT, LiteralT, ClauseIdT>::isVariableSingleton(VarT var) const {
    ...
    template <typename VarT, typename LiteralT, typename ClauseIdT>
    ClauseIdT ContiguousFormulaRepresentation<VarT, LiteralT, ClauseIdT>::getNumberOfCurrentClauses(LiteralT literalT) const {
    ...
    template <typename VarT, typename LiteralT, typename ClauseIdT>
    typename ContiguousFormulaRepresentation<VarT, LiteralT, ClauseIdT>::ClauseSizeCounterType
    ContiguousFormulaRepresentation<VarT, LiteralT, ClauseIdT>::getCurrentClauseSizeCounter(LiteralT literalT) const {
        assert(!this->isVariableAssigned(createLiteralFromLiteralT<VarT, LiteralT>(literalT).getVariable()));           // variable is not assigned
        assert(isVariableInCurrentComponentDebug(createLiteralFromLiteralT<VarT, LiteralT>(literalT).getVariable()));   // variable is in the current component
    ...
    template <typename VarT, typename LiteralT, typename ClauseIdT>
    ClauseIdT ContiguousFormulaRepresentation<VarT, LiteralT, ClauseIdT>::getNumberOfCurrentBinaryClauses(LiteralT literalT) const {
        assert(!this->isVariableAssigned(createLiteralFromLiteralT<VarT, LiteralT>(literalT).getVariable()));           // variable is not assigned
        assert(isVariableInCurrentComponentDebug(createLiteralFromLiteralT<VarT, LiteralT>(literalT).getVariable()));   // variable is in the current component
    ...
    template <typename VarT, typename LiteralT, typename ClauseIdT>
    FormulaSizeType ContiguousFormulaRepresentation<VarT, LiteralT, ClauseIdT>::getCurrentComponentFormulaSize([[maybe_unused]] const VariableSetType& currentComponentVariableSet) const noexcept {
        return currentComponentFormulaSize_;
    }

    template <typename VarT, typename LiteralT, typename ClauseIdT>
    typename ContiguousFormulaRepresentation<VarT, LiteralT, ClauseIdT>::PureVariableRemovedClausesVectorType
    ContiguousFormulaRepresentation<VarT, LiteralT, ClauseIdT>::setNewComponent(const ConnectedComponentStruct& newConnectedComponentStruct,
                                                                                IgnorePureLiteralTypeEnum ignorePureLiteralType) {
    ...
    template <typename VarT, typename LiteralT, typename ClauseIdT>
    void ContiguousFormulaRepresentation<VarT, LiteralT, ClauseIdT>::popPreviousComponent(const ConnectedComponentStruct& currentConnectedComponentStruct,
    ...
    template <typename VarT, typename LiteralT, typename ClauseIdT>
    ClauseIdT ContiguousFormulaRepresentation<VarT, LiteralT, ClauseIdT>::getNumberOfCurrentComponentClauses([[maybe_unused]] const VariableSetType& currentComponentVariableSet) const noexcept {
        return static_cast<ClauseIdT>(currentComponentClausesFixedVector_.size());
    }

    template <typename VarT, typename LiteralT, typename ClauseIdT>
    void ContiguousFormulaRepresentation<VarT, LiteralT, ClauseIdT>::getCurrentComponentClauses([[maybe_unused]] const VariableSetType& currentComponentVariableSet,
    ...
    template <typename VarT, typename LiteralT, typename ClauseIdT>
    void ContiguousFormulaRepresentation<VarT, LiteralT, ClauseIdT>::getCurrentComponentNotDuplicateClauses([[maybe_unused]] const VariableSetType& currentComponentVariableSet,
                                                                                                            ClauseIdReusableVectorType& clauseIdReusableVector,
    ...
    template <typename VarT, typename LiteralT, typename ClauseIdT>
    void ContiguousFormulaRepresentation<VarT, LiteralT, ClauseIdT>::getSortedCurrentComponentClauses([[maybe_unused]] const VariableSetType& currentComponentVariableSet,
                                                                                                      ClauseIdReusableVectorType& clauseIdReusableVector,
    ...
    template <typename VarT, typename LiteralT, typename ClauseIdT>
    void ContiguousFormulaRepresentation<VarT, LiteralT, ClauseIdT>::getCurrentComponentNotSubsumedClauses([[maybe_unused]] const VariableSetType& currentComponentVariableSet,
                                                                                                           ClauseIdReusableVectorType& clauseIdReusableVector,
        ...
        switch (configuration_.subsumptionType) {
            ...
            default:
                throw Exception::NotImplementedException(subsumptionTypeEnumToString(configuration_.subsumptionType),
                                                         "Hydra::Formula::Representation::Contiguous::ContiguousFormulaRepresentation::getCurrentComponentNotSubsumedClauses");
        }
    ...
    template <typename VarT, typename LiteralT, typename ClauseIdT>
    void ContiguousFormulaRepresentation<VarT, LiteralT, ClauseIdT>::getSortedCurrentComponentNotSubsumedClauses([[maybe_unused]] const VariableSetType& currentComponentVariableSet,
        ...
        switch (configuration_.subsumptionType) {
            ...
            default:
                throw Exception::NotImplementedException(subsumptionTypeEnumToString(configuration_.subsumptionType),
                                                         "Hydra::Formula::Representation::Contiguous::ContiguousFormulaRepresentation::getSortedCurrentComponentNotSubsumedClauses");
        }
    ...
    template <typename VarT, typename LiteralT, typename ClauseIdT>
    void ContiguousFormulaRepresentation<VarT, LiteralT, ClauseIdT>::getCurrentComponentClausesThatVariableSubsumeSomeClause([[maybe_unused]] const VariableSetType& currentComponentVariableSet,
    ...
    template <typename VarT, typename LiteralT, typename ClauseIdT>
    void ContiguousFormulaRepresentation<VarT, LiteralT, ClauseIdT>::getCurrentClauses([[maybe_unused]] const VariableSetType& currentComponentVariableSet,
    ...
    template <typename VarT, typename LiteralT, typename ClauseIdT>
    typename ContiguousFormulaRepresentation<VarT, LiteralT, ClauseIdT>::VariableSetType
    ContiguousFormulaRepresentation<VarT, LiteralT, ClauseIdT>::getUnassignedVariablesInClause(ClauseIdT clauseId) const {
        assert(clauseId < this->numberOfOriginalClauses_);
        assert(!this->isClauseSatisfied(clauseId));   // clause is not satisfied
    ...
    template <typename VarT, typename LiteralT, typename ClauseIdT>
    void ContiguousFormulaRepresentation<VarT, LiteralT, ClauseIdT>::printCurrentFormulaInDimacsCnfFormat(std::ostream& out, bool printProblemLine,
    ...
    template <typename VarT, typename LiteralT, typename ClauseIdT>
    void ContiguousFormulaRepresentation<VarT, LiteralT, ClauseIdT>::printSortedCurrentFormulaInDimacsCnfFormat(std::ostream& out,
    ...
    ContiguousFormulaRepresentation<VarT, LiteralT, ClauseIdT>::beginClause(ClauseIdT clauseId, [[maybe_unused]] bool checkSat) const {
        assert(clauseId < this->numberOfOriginalClauses_);
    ...
    template <typename VarT, typename LiteralT, typename ClauseIdT>
    typename FormulaRepresentationAbstract<VarT, LiteralT, ClauseIdT>::ClauseIterator
    ContiguousFormulaRepresentation<VarT, LiteralT, ClauseIdT>::beginSortedClause(ClauseIdT clauseId, [[maybe_unused]] bool checkSat) const {
        assert(clauseId < this->numberOfOriginalClauses_);
    ...
    #ifndef NDEBUG
    template <typename VarT, typename LiteralT, typename ClauseIdT>
    void ContiguousFormulaRepresentation<VarT, LiteralT, ClauseIdT>::processPrintFormulaRepresentationDebug(std::ostream& out) const {
    ...
    template <typename VarT, typename LiteralT, typename ClauseIdT>
    bool ContiguousFormulaRepresentation<VarT, LiteralT, ClauseIdT>::isVariableInCurrentComponentDebug(VarT var) const {
        assert(!d_currentComponentVariableSetStack_.empty());
    ...
    template <typename VarT, typename LiteralT, typename ClauseIdT>
    void ContiguousFormulaRepresentation<VarT, LiteralT, ClauseIdT>::printCurrentClauseDebug(std::ostream& out, ClauseIdT clauseId,
                                                                                             bool considerOnlyVariables) const {
        for (auto clauseIt = beginSortedClause(clauseId); clauseIt != this->endSortedClause(); ++clauseIt) {
            // Variables
            if (considerOnlyVariables)
    ...
    template <typename VarT, typename LiteralT, typename ClauseIdT>
    void ContiguousFormulaRepresentation<VarT, LiteralT, ClauseIdT>::printCurrentFormulaDebug(std::ostream& out, bool removeDuplicateClauses,
