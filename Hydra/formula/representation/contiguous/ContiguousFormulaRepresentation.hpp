...
namespace Hydra::Formula::Representation::Contiguous {
    ...
    /**
     * Contiguous formula representation (final class)
    ...
    private:
        ...
        public:
            explicit ClauseSizeComparator(ContiguousFormulaRepresentationPtrType contiguousFormulaRepresentationPtr)
                : contiguousFormulaRepresentationPtr_(contiguousFormulaRepresentationPtr) { }

        private:
            ContiguousFormulaRepresentationPtrType contiguousFormulaRepresentationPtr_;
        ...
        public:
            explicit ClauseComparator(ContiguousFormulaRepresentationPtrType contiguousFormulaRepresentationPtr)
                : contiguousFormulaRepresentationPtr_(contiguousFormulaRepresentationPtr) { }
        ...
        public:
            explicit ClauseVariableComparator(ContiguousFormulaRepresentationPtrType contiguousFormulaRepresentationPtr)
                : contiguousFormulaRepresentationPtr_(contiguousFormulaRepresentationPtr) { }
    ...
    public:
        #ifndef NDEBUG
        ContiguousFormulaRepresentation(FormulaType&& formula, VarT numberOfVariables, ClauseIdT numberOfClauses,
            ...
            : FormulaRepresentationAbstract<VarT, LiteralT, ClauseIdT>(FormulaRepresentationTypeEnum::CONTIGUOUS,
        ...
        ContiguousFormulaRepresentation(const FormulaType& formula, VarT numberOfVariables, ClauseIdT numberOfClauses,
                                        const ClauseIdVectorType& literalNumberOfOccurrences,
                                        const ContiguousFormulaRepresentationConfiguration& configuration = ContiguousFormulaRepresentationConfiguration(),
                                        FormulaRepresentationStatisticsPtrType formulaRepresentationStatisticsPtr = nullptr)
            : FormulaRepresentationAbstract<VarT, LiteralT, ClauseIdT>(FormulaRepresentationTypeEnum::CONTIGUOUS,
    ...
    private:
        ...
        ContiguousFormulaRepresentationConfiguration configuration_;
...
#include "./ContiguousFormulaRepresentation.ipp"
#include "./ContiguousFormulaRepresentationComparator.ipp"
#include "./ContiguousFormulaRepresentationSubsumption.ipp"
#include "./ContiguousFormulaRepresentationVariableSubsumptionWithMapping.ipp"
