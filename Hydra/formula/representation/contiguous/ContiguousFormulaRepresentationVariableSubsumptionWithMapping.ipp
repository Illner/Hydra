...
namespace Hydra::Formula::Representation::Contiguous {
    ...
    bool ContiguousFormulaRepresentation<VarT, LiteralT, ClauseIdT>::clauseVariableSubsumesWithMappingClause(ClauseIdT clauseId1, ClauseIdT clauseId2,
    ...
    template <typename VarT, typename LiteralT, typename ClauseIdT>
    void ContiguousFormulaRepresentation<VarT, LiteralT, ClauseIdT>::forwardVariableSubsumptionWithMappingDetection(VectorSetType& clauseThatVariableSubsumesSomeClauseVectorSet,
                                                                                                                    const VariableVectorMapType& variableVectorMap,
    ...
    template <typename VarT, typename LiteralT, typename ClauseIdT>
    void ContiguousFormulaRepresentation<VarT, LiteralT, ClauseIdT>::oneLiteralWatchingAlgorithmVariableSubsumptionWithMapping(VectorSetType& clauseThatVariableSubsumesSomeClauseVectorSet,
                                                                                                                               const VariableVectorMapType& variableVectorMap,
                                                                                                                               IgnorePureLiteralTypeEnum ignorePureLiteralType,
                                                                                                                               VertexWeightTypeEnum vertexWeightType,
                                                                                                                               VertexWeightVectorType& vertexWeightVector) const {
    ...
    template <typename VarT, typename LiteralT, typename ClauseIdT>
    void ContiguousFormulaRepresentation<VarT, LiteralT, ClauseIdT>::processClauseOneLiteralWatchingAlgorithmVariableSubsumptionWithMapping(ClauseIdT clauseId,
    ...
    template <typename VarT, typename LiteralT, typename ClauseIdT>
    bool ContiguousFormulaRepresentation<VarT, LiteralT, ClauseIdT>::updateWatcherOneLiteralWatchingAlgorithmVariableSubsumptionWithMapping(ClauseIdT clauseId,
                                                                                                                                            const VariableVectorMapType& variableVectorMap,
                                                                                                                                            IgnorePureLiteralTypeEnum ignorePureLiteralType) const {
