#include "./HypergraphPartitioningAbstract.hxx"

namespace Hydra::HypergraphPartitioning {

    void HypergraphPartitioningStatistics::processPrintStatistics(std::ostream& out, const std::string& statisticsName, bool addLabels) const {
