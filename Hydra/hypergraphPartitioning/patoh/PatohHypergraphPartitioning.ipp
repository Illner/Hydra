...
#include "./PatohHypergraphPartitioning.hpp"

namespace Hydra::HypergraphPartitioning::Patoh {

    template <typename VarT, typename LiteralT, typename ClauseIdT>
    typename PatohHypergraphPartitioning<VarT, LiteralT, ClauseIdT>::VariableSetType
    PatohHypergraphPartitioning<VarT, LiteralT, ClauseIdT>::computeCut(const OccurrenceListStruct& occurrenceListStruct) {
        // Fill xpins and pins
    ...
    #ifndef NDEBUG
    template <typename VarT, typename LiteralT, typename ClauseIdT>
    void PatohHypergraphPartitioning<VarT, LiteralT, ClauseIdT>::processPrintHypergraphPartitioningDebug(std::ostream& out) const {
        // Configuration
