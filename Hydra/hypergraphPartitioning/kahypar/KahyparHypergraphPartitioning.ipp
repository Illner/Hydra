...
#include "./KahyparHypergraphPartitioning.hpp"

namespace Hydra::HypergraphPartitioning::Kahypar {

    template <typename VarT, typename LiteralT, typename ClauseIdT>
    typename KahyparHypergraphPartitioning<VarT, LiteralT, ClauseIdT>::VariableSetType
    KahyparHypergraphPartitioning<VarT, LiteralT, ClauseIdT>::computeCut(const OccurrenceListStruct& occurrenceListStruct) {
        // Fill xpins and pins
    ...
    #ifndef NDEBUG
    template <typename VarT, typename LiteralT, typename ClauseIdT>
    void KahyparHypergraphPartitioning<VarT, LiteralT, ClauseIdT>::processPrintHypergraphPartitioningDebug(std::ostream& out) const {
        // Configuration
