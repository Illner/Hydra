...
namespace Hydra::HypergraphPartitioning {
    ...
    /**
     * Hypergraph partitioning representation (abstract class)
    ...
    public:
        ...
        using HypergraphPartitioningStatisticsPtrType = typename HypergraphPartitioningStatistics::HypergraphPartitioningStatisticsPtrType;
    ...
    public:
        HypergraphPartitioningAbstract(FormulaRepresentationAbstractPtrType formulaRepresentationAbstractPtr,
                                       bool allowEmptyHypergraphCut, bool allowSingletonHyperedge,
                                       HypergraphPartitioningSoftwareEnum hypergraphPartitioningSoftware, IgnorePureLiteralTypeEnum ignorePureLiteralType,
                                       VertexWeightTypeEnum vertexWeightType, HypergraphPartitioningStatisticsPtrType hypergraphPartitioningStatisticsPtr,
                                       ModulePointersStruct modulePointersStruct = ModulePointersStruct())
            : module_(modulePointersStruct.vertexWeightVectorPtr), wrapper_(hypergraphPartitioningSoftware == HypergraphPartitioningSoftwareEnum::WRAPPER),
              ...
              ignorePureLiteralType_(ignorePureLiteralType), hypergraphPartitioningSoftware_(hypergraphPartitioningSoftware), modulePointersStruct_(modulePointersStruct),
              ...
              formulaRepresentationAbstractPtr_(formulaRepresentationAbstractPtr), hypergraphPartitioningStatisticsPtr_(hypergraphPartitioningStatisticsPtr) {
        ...
        HypergraphPartitioningAbstract(const HypergraphPartitioningAbstract&) = delete;
        HypergraphPartitioningAbstract(HypergraphPartitioningAbstract&&) noexcept = delete;

        HypergraphPartitioningAbstract& operator=(const HypergraphPartitioningAbstract&) = delete;
        HypergraphPartitioningAbstract& operator=(HypergraphPartitioningAbstract&&) noexcept = delete;

        virtual ~HypergraphPartitioningAbstract() noexcept = default;
    ...
    private:
        ...
        HypergraphPartitioningSoftwareEnum hypergraphPartitioningSoftware_;
    ...
    protected:
        ...
        HypergraphPartitioningStatisticsPtrType hypergraphPartitioningStatisticsPtr_;
    ...
    public:
        ...
        void printHypergraphPartitioningDebug(std::ostream& out, bool printCurrentFormula = false) const;

    protected:
        virtual void processPrintHypergraphPartitioningDebug(std::ostream& out) const = 0;
    #endif
...
#include "./HypergraphPartitioningAbstract.ipp"
