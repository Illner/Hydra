...
#include "./HypergraphPartitioningAbstract.hpp"

namespace Hydra::HypergraphPartitioning {

    template <typename VarT, typename LiteralT, typename ClauseIdT>
    const HypergraphPartitioningAbstract<VarT, LiteralT, ClauseIdT>::VertexWeightVectorType&
    HypergraphPartitioningAbstract<VarT, LiteralT, ClauseIdT>::getClauseVertexWeightVector() const noexcept {
        return (module_ ? *(modulePointersStruct_.clauseVertexWeightVectorPtr) : clauseVertexWeightVector_);
    }

    template <typename VarT, typename LiteralT, typename ClauseIdT>
    HypergraphPartitioningAbstract<VarT, LiteralT, ClauseIdT>::VertexWeightVectorType&
    HypergraphPartitioningAbstract<VarT, LiteralT, ClauseIdT>::getVertexWeightVector() noexcept {
        return (module_ ? *(modulePointersStruct_.vertexWeightVectorPtr) : vertexWeightVector_);
    }

    template <typename VarT, typename LiteralT, typename ClauseIdT>
    HypergraphPartitioningAbstract<VarT, LiteralT, ClauseIdT>::PartitionNumberVectorMapType&
    HypergraphPartitioningAbstract<VarT, LiteralT, ClauseIdT>::getPartitionNumberVectorMap() noexcept {
        return (module_ ? *(modulePointersStruct_.partitionNumberVectorMapPtr) : partitionNumberVectorMap_);
    }

    template <typename VarT, typename LiteralT, typename ClauseIdT>
    void HypergraphPartitioningAbstract<VarT, LiteralT, ClauseIdT>::createEquivalenceStruct(const VariableSetType& currentComponentVariableSet,
        ...
        // Statistics
        if (hypergraphPartitioningStatisticsPtr_)
            hypergraphPartitioningStatisticsPtr_->createEquivalenceStructTimer.startStopwatch();
        ...
        // Statistics
        if (hypergraphPartitioningStatisticsPtr_)
            hypergraphPartitioningStatisticsPtr_->createEquivalenceStructTimer.stopStopwatch();
    }

    template <typename VarT, typename LiteralT, typename ClauseIdT>
    void HypergraphPartitioningAbstract<VarT, LiteralT, ClauseIdT>::createOccurrenceListStruct(const VariableReusableVectorType& variableOrderReusableVector,
        ...
        // Statistics
        if (hypergraphPartitioningStatisticsPtr_)
            hypergraphPartitioningStatisticsPtr_->createOccurrenceListStructTimer.startStopwatch();
                    ...
                    switch (ignorePureLiteralType_) {
                        ...
                        default:
                            throw Exception::NotImplementedException(ignorePureLiteralTypeEnumToString(ignorePureLiteralType_),
                                                                     "Hydra::HypergraphPartitioning::HypergraphPartitioningAbstract::createOccurrenceListStruct (debug)");
                    }
        ...
        if (hypergraphPartitioningStatisticsPtr_) {
            // Vertices
            hypergraphPartitioningStatisticsPtr_->numberOfVerticesCounter.addCount(static_cast<Statistics::LargeNumberType>(l_occurrenceListStruct_.numberOfDifferentClausesInOccurrenceList));
            hypergraphPartitioningStatisticsPtr_->ratioOfNumberOfVerticesToNumberOfClausesCounter.addCount(static_cast<Statistics::LargeFloatingNumberType>(l_occurrenceListStruct_.numberOfDifferentClausesInOccurrenceList) / static_cast<Statistics::LargeFloatingNumberType>(formulaRepresentationAbstractPtr_->getNumberOfCurrentComponentClauses(currentComponentVariableSet)));

            // Hyperedges
            hypergraphPartitioningStatisticsPtr_->numberOfHyperedgesCounter.addCount(static_cast<Statistics::LargeNumberType>(l_occurrenceListStruct_.variableOrderReusableVector.size()));
            hypergraphPartitioningStatisticsPtr_->ratioOfNumberOfHyperedgesToNumberOfVariablesCounter.addCount(static_cast<Statistics::LargeFloatingNumberType>(l_occurrenceListStruct_.variableOrderReusableVector.size()) / static_cast<Statistics::LargeFloatingNumberType>(currentComponentVariableSet.size()));

            // Hypergraph
            hypergraphPartitioningStatisticsPtr_->hypergraphSizeCounter.addCount(static_cast<Statistics::LargeNumberType>(l_occurrenceListStruct_.occurrenceListSize));
            hypergraphPartitioningStatisticsPtr_->ratioOfHypergraphSizeToFormulaSizeCounter.addCount(static_cast<Statistics::LargeFloatingNumberType>(l_occurrenceListStruct_.occurrenceListSize) / static_cast<Statistics::LargeFloatingNumberType>(formulaRepresentationAbstractPtr_->getCurrentComponentFormulaSize(currentComponentVariableSet)));

            hypergraphPartitioningStatisticsPtr_->createOccurrenceListStructTimer.stopStopwatch();
        }
    }

    template <typename VarT, typename LiteralT, typename ClauseIdT>
    template <typename XpinT, typename PinT>
    void HypergraphPartitioningAbstract<VarT, LiteralT, ClauseIdT>::fillXpinsAndPins(const OccurrenceListStruct& occurrenceListStruct,
    ...
    template <typename VarT, typename LiteralT, typename ClauseIdT>
    const typename HypergraphPartitioningAbstract<VarT, LiteralT, ClauseIdT>::PartitionNumberVectorMapType&
    HypergraphPartitioningAbstract<VarT, LiteralT, ClauseIdT>::createPreassignmentOfClauseIndices([[maybe_unused]] const OccurrenceListStruct& occurrenceListStruct,
    ...
    template <typename VarT, typename LiteralT, typename ClauseIdT>
    typename HypergraphPartitioningAbstract<VarT, LiteralT, ClauseIdT>::VertexWeightVectorType&
    HypergraphPartitioningAbstract<VarT, LiteralT, ClauseIdT>::createVertexWeightVector(const OccurrenceListStruct& occurrenceListStruct) {
        assert(!wrapper_);
    ...
    template <typename VarT, typename LiteralT, typename ClauseIdT>
    typename HypergraphPartitioningAbstract<VarT, LiteralT, ClauseIdT>::VariableSetType
    HypergraphPartitioningAbstract<VarT, LiteralT, ClauseIdT>::extractCut(const OccurrenceListStruct& occurrenceListStruct, const PartvecType& partvec) const {
        assert(!wrapper_);
    ...
    template <typename VarT, typename LiteralT, typename ClauseIdT>
    typename HypergraphPartitioningAbstract<VarT, LiteralT, ClauseIdT>::VariableSetType
    HypergraphPartitioningAbstract<VarT, LiteralT, ClauseIdT>::computeCut(const VariableSetType& currentComponentVariableSet) {
        assert(!module_);
    ...
    template <typename VarT, typename LiteralT, typename ClauseIdT>
    typename HypergraphPartitioningAbstract<VarT, LiteralT, ClauseIdT>::VariableSetType
    HypergraphPartitioningAbstract<VarT, LiteralT, ClauseIdT>::computeCut(const VariableSetType& currentComponentVariableSet, bool& validCut) {
        assert(!module_);
        ...
        // Statistics
        if (hypergraphPartitioningStatisticsPtr_)
            hypergraphPartitioningStatisticsPtr_->computeCutTimer.startStopwatch();

        VariableSetType cut = computeCut(l_occurrenceListStruct_);

        // Statistics
        if (hypergraphPartitioningStatisticsPtr_) {
            hypergraphPartitioningStatisticsPtr_->cutSizeCounter.addCount(static_cast<Statistics::LargeNumberType>(cut.size()));
            hypergraphPartitioningStatisticsPtr_->ratioOfCutSizeToNumberOfVariablesCounter.addCount(static_cast<Statistics::LargeFloatingNumberType>(cut.size()) / static_cast<Statistics::LargeFloatingNumberType>(currentComponentVariableSet.size()));

            hypergraphPartitioningStatisticsPtr_->computeCutTimer.stopStopwatch();
        }
    ...
    #ifndef NDEBUG
    template <typename VarT, typename LiteralT, typename ClauseIdT>
    void HypergraphPartitioningAbstract<VarT, LiteralT, ClauseIdT>::printVertexWeightVectorDebug(std::ostream& out) const {
        out << "Vertex weights:";
    ...
    template <typename VarT, typename LiteralT, typename ClauseIdT>
    void HypergraphPartitioningAbstract<VarT, LiteralT, ClauseIdT>::printHypergraphPartitioningDebug(std::ostream& out, bool printCurrentFormula) const {
        out << "Hypergraph partitioning" << std::endl;
        out << "Software: " << hypergraphPartitioningSoftwareEnumToString(hypergraphPartitioningSoftware_) << std::endl;
        ...
        this->processPrintHypergraphPartitioningDebug(out);
    ...
    #if defined(TEST)
    template <typename VarT, typename LiteralT, typename ClauseIdT>
    HypergraphPartitioningAbstract<VarT, LiteralT, ClauseIdT>::VariableVectorMapType&
    HypergraphPartitioningAbstract<VarT, LiteralT, ClauseIdT>::getEquivalenceVectorMap() const noexcept {
        return l_equivalenceVectorMap_equivalenceStruct_;
    }

    template <typename VarT, typename LiteralT, typename ClauseIdT>
    HypergraphPartitioningAbstract<VarT, LiteralT, ClauseIdT>::VariableReusableVectorType&
    HypergraphPartitioningAbstract<VarT, LiteralT, ClauseIdT>::getVariableOrderReusableVector() const noexcept {
        return l_variableOrderReusableVector_equivalenceStruct_;
    }

    template <typename VarT, typename LiteralT, typename ClauseIdT>
    HypergraphPartitioningAbstract<VarT, LiteralT, ClauseIdT>::EquivalenceStructureVectorType&
    HypergraphPartitioningAbstract<VarT, LiteralT, ClauseIdT>::getEquivalenceStructureVector() const noexcept {
        return l_equivalenceStructureVector_equivalenceStruct_;
    }

    template <typename VarT, typename LiteralT, typename ClauseIdT>
    HypergraphPartitioningAbstract<VarT, LiteralT, ClauseIdT>::OccurrenceListStruct&
    HypergraphPartitioningAbstract<VarT, LiteralT, ClauseIdT>::getOccurrenceListStruct() const noexcept {
